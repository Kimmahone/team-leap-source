...
**좌표는 이미 다 있습니다.** 학교 917곳 가운데 좌표가 없는 곳은 **포항해오름중학교 한 곳**이고, 유치원은 613곳이 공식 좌표에 한 곳만 주소 변환값입니다. 이 API 를 붙여도 채워지는 것은 그 한 곳뿐입니다.

SGIS 와도 다른 이야기입니다. SGIS 가 주는 것은 **시군 경계**(간편 지도의 배경)와 **온라인 지도 서비스**이고, 학교 위치가 아닙니다. 학교 좌표는 학교알리미(`bake-coords.mjs`)에서 옵니다. 셋이 서로 다른 자료입니다.

쓸모가 아주 없지는 않습니다 — 지금 좌표가 맞는지 공식 위치정보와 **맞대어 볼** 수는 있습니다. 다만 한 곳을 채우자고 API 를 하나 더 매달 까닭은 없습니다.

### 시군을 못 붙이는 학교 — 얼마나 되나

2016년 기준으로 **군위 15곳(1,157명)** 과 **못 찾은 43곳(971명)** 입니다. 둘은 성격이 다릅니다.

**군위는 일부러 뺍니다.** 2023. 7. 1. 대구로 넘어가 지금 경북이 아닙니다. 옛 자료에는 남아 있는데, 넣으면 2016년만 경북이 넓어져 **감소가 실제보다 가팔라** 보입니다(16.75% → 17.08%). 열 해 내내 빼서 **같은 땅**을 견줍니다.

**못 찾은 43곳**은 2016년에 있다가 그 뒤 문을 닫아 지금 어느 명부에도 없는 학교들입니다. 본교까지 없어진 분교장, 이름이 두 시군에 걸치는 학교(남산초등학교 — 영주·경산)도 섞여 있습니다.

| | 2016 | 2025 |
|---|---|---|
| 못 찾은 학생 | 971명 (**0.34%**) | 81명 (**0.03%**) |

옛 해가 조금 더 많이 빠지므로 **감소가 실제보다 0.25%p 덜 잡힙니다**(16.75% 대신 17.00%). 방향은 알고 있고, 크기는 이 정도입니다.

## 1. 어디에 무엇이 있나## 1. 어디에 무엇이 있나## 1. 어디에 무엇이 있나## 1. 어디에 무엇이 있나
